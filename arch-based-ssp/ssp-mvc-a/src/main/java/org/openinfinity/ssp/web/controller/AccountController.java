...
public class AccountController {
	...
	public String createNewAccount(Model model) {
		model.addAttribute(new AccountModel());
		return "account";
	}
	...
	public @ResponseBody Map<String, ? extends Object> create(@Valid @RequestBody AccountModel accountModel, HttpServletResponse response) {
		Set<ConstraintViolation<AccountModel>> failures = validator.validate(accountModel);
		if (failures.isEmpty()) {
	...
	private Map<String, String> getValidationMessages(Set<ConstraintViolation<AccountModel>> failures) {
		Map<String, String> failureMessages = new HashMap<String, String>();
		for (ConstraintViolation<AccountModel> failure : failures) {
