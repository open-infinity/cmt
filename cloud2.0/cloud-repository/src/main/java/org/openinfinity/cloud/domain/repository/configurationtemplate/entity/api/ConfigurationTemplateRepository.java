 ...
 */
package org.openinfinity.cloud.domain.repository.configurationtemplate.entity.api;
 ...
 * @since 1.3.0
 */
public interface ConfigurationTemplateRepository extends AbstractCrudRepositoryInterface<ConfigurationTemplate> {
	
    List<ConfigurationTemplate> loadForOrganizarion(Long oid);
