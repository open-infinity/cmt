class oi3-bigdatahost-backup::config {
	file {"/opt/openinfinity/3.1.0/backup/common/bigdata-common":
		ensure => present,
	...
	file {"/opt/openinfinity/3.1.0/backup/cluster-backup-before.d/before-bigdata-cluster-backup":
		ensure => present,
	...
	file {"/opt/openinfinity/3.1.0/backup/cluster-backup-after.d/after-bigdata-cluster-backup":
		ensure => present,
	...
	file {"/opt/openinfinity/3.1.0/backup/node-backup-before.d/before-bigdata-node-backup":
		ensure => present,
	...
	file {"/opt/openinfinity/3.1.0/backup/node-backup-after.d/after-bigdata-node-backup":
		ensure => present,
