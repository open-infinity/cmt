...
@Service
public class TemplateToOrganizationServiceImpl implements TemplateToOrganizationService {
	private static final Logger LOGGER = Logger.getLogger(TemplateToOrganizationServiceImpl.class.getName());
    ...
    public void create(int templateId, int organizationId) {
        templateToOrganizationRepository.create(templateId, organizationId);
    }

    @Override
    public Collection<TemplateToOrganization> loadAllForTemplate(int templateId){
       return templateToOrganizationRepository.loadAllForTemplate(templateId);
    }
