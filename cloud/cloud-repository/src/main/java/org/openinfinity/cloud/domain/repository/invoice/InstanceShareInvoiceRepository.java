...
public interface InstanceShareInvoiceRepository extends JpaRepository<InstanceShareInvoice, Long>{
    
    @Query("select u from InstanceShareInvoice u where u.instanceShare.id = ?1")
