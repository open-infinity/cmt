...
public interface InstanceShareDetailRepository extends JpaRepository<InstanceShareDetail, Long>{
    
    @Query("select u from InstanceShareDetail u where u.instanceShare.id = ?1")
    List<InstanceShareDetail> findByInstanceShareId(long instanceId);
}
