 ...
 */
@Repository
public class TemplateToOrganizationRepositoryJdbcImpl implements TemplateToOrganizationRepository {
    ...
    @AuditTrail
    @Transactional
    public List<TemplateToOrganization> loadAll() {
        return null;
    }

    @Override
    public Collection<TemplateToOrganization> loadAllForTemplate(int templateId){
    ...
    private class OrganizationRowMapper implements RowMapper<TemplateToOrganization> {
		
		public TemplateToOrganization mapRow(ResultSet resultSet, int rowNum) throws SQLException {
		    return new TemplateToOrganization(resultSet.getLong("template_id"), resultSet.getInt("organization_id"));
		}
	}
