...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/css/ssp/ssp.css" />" type="text/css" media="screen, projection">
...
<div class="container">
        ...
        <div>
	        ...
	        <div class = "alligned-right" ><a href="/ssp-mvc/user"> User</a> </div>
	        <div class = "alligned-right" ><a href="/ssp-mvc/product">Product</a> </div>
	        <div class = "alligned-right" ><a href="/ssp-mvc/payment">Payment</a> </div>
