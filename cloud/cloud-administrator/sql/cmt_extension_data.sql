...
insert into acl_cluster_type_tbl select 'OPPYATOAS', id from cluster_type_tbl where name in ('yaportal', 'yamq');  -- OPPYATOAS can use only yaportal and yamq
insert into acl_cluster_type_tbl select 'TOAS', id from cluster_type_tbl where name not in ('yaportal', 'yamq');   -- allow all platforms except yaportal and yamq
insert into acl_cluster_type_tbl select 'Tieto Finland', id from cluster_type_tbl where name not in ('yaportal', 'yamq'); -- allow all platforms except yaportal and yamq
